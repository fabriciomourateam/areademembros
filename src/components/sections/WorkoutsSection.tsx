        ...
        <CardHeader className="pb-6 bg-gradient-to-r from-orange-50 to-red-50">
          <CardTitle className="flex items-center gap-3 text-orange-800">
            ...
            <div>
              ...
              <div className="text-sm text-orange-600/70 font-normal">Base para resultados reais</div>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <p className="text-orange-700/80 leading-relaxed text-lg">
              Para ter resultados reais, você precisa dar o seu máximo em cada treino.
              O foco é sempre em progressão de carga e de esforço, com boa técnica e buscando a falha muscular em todos os exercícios.
            </p>
            ...
            <div className="gradient-card p-6 rounded-xl border border-orange-200/50">
              ...
              <div className="space-y-3 text-orange-700/80">
                <p>Se a faixa de repetições for de <strong>8 a 10</strong>, o ideal é chegar à falha dentro dessa faixa.</p>
        ...
        <CardHeader className="pb-6 bg-gradient-to-r from-pink-50 to-purple-50">
          <CardTitle className="flex items-center gap-3 text-pink-800">
            ...
            <div>
              ...
              <div className="text-sm text-pink-600/70 font-normal">Veja na prática como fazer</div>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="text-center">
              <h4 className="font-bold text-pink-800 mb-4">Exemplo 1 - Execução Perfeita</h4>
              <Button 
            ...
            <div className="text-center">
              <h4 className="font-bold text-pink-800 mb-4">Exemplo 2 - Técnica Avançada</h4>
              <Button 
                className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-0 rounded-xl w-full"
        ...
        <CardHeader className="pb-6 bg-gradient-to-r from-blue-50 to-cyan-50">
          <CardTitle className="flex items-center gap-3 text-blue-800">
            ...
            <div>
              ...
              <div className="text-sm text-blue-600/70 font-normal">Entenda o propósito</div>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent>
        ...
        <CardHeader className="pb-6 bg-gradient-to-r from-green-50 to-emerald-50">
          <CardTitle className="flex items-center gap-3 text-green-800">
            ...
            <div>
              ...
              <div className="text-sm text-green-600/70 font-normal">Lembre-se sempre</div>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent>
        ...
        <CardHeader className="pb-6 bg-gradient-to-r from-red-50 to-pink-50">
          <CardTitle className="flex items-center gap-3 text-red-800">
            ...
            <div>
              ...
              <div className="text-sm text-red-600/70 font-normal">Conhecimento avançado</div>
            </div>
          </CardTitle>
        </CardHeader>
        <CardContent>
